...
\begin{tabular}{lll}
  ...
  2016--2018 & M. in Applied Statistics & Central University of Finance and Economics, China \\ 
        & Supervisors: & \href{https://feng.li/}{A/Prof. Feng Li} \\
...
awards <- tribble(
  ~Start, ~End, ~Project,
  2018.07, 2019.01, "\\textbf{Research Assistant}, National Natural Science Foundation of China Project: NSFC-11501587",
) %>%
  arrange(-Start) %>%
  mutate(End = replace_na(as.character(End), "")) %>%
  mutate(Years = paste(Start, "--", End, sep = "")) %>%
...
awards <- tribble(
  ~Year, ~Award,
  2022, "Purple Letter (Outstanding Unit Evaluation of Teaching) for Tutoring ETF3500 2021S2, Monash Business School", 
  2021, "Purple Letter (Outstanding Unit Evaluation of Teaching) for Tutoring ETC5513 2021S1, Monash Business School", 
